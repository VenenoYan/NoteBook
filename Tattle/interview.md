...
我觉得两句话可以概括我的特点，第一个就是“狮子搏兔亦用全力，更何况我们可能只是那只”个人比较喜欢学习新的知识，比如Git就是研一自己学习的，后来数据挖掘比较火，自己又自学了python以及爬虫scrapy的使用，了解了正则表达式；正好到研二自己主动申请去上海的时候，第一个项目就是使用python的Djingo框架进行开发。
