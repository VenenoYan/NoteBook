...
##自我介绍
面试官老师，您好！我叫张状，今年25岁，就读于中科院软件研究所。熟悉C++，良好的英语阅读能力，熟练使用Git，有代码库管理的经验。我认为自己面试这个岗位的优势，第一个是比较好的学习能力，在上海实习期间，我在微架构的知识储备基本为0情况下，用了四个月左右的时间熟悉了整个微架构的构成和功能模块，最终得到认可参与到公司核心项目微架构模拟器的设计与开发中，同时三次被选为优秀员工。
我比较喜欢学习新的知识，比如Git就是自己课余时间学习的，后来数据挖掘比较火，自己又自学了python正好实验室项目就是使用python的Djingo框架进行开发，了解了正则表达式。
最后一个就是良好的交际能力，自己在研究生举办了第一届的学生运动会以及篮球赛等各项赛事，
协调数十个班级和七个部门，顺利举办。我以往的活动中，我更加重视团队的力量，所以希望未来能加入到一个比较完善、有挑战性的团队中。
谢谢！
