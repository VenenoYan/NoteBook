...
　　　　　T0 ... Tj-1 Tj　...  Ti-j-1 ... Ti-2 Ti-1 即【T0 ... Tj-1】 = 【Ti-j-1 ... Ti-2】
    对于i ： 如果S[i-1]和next[i-1]的下一个字符相同，那么对于i前后缀匹配的字符串长度比i-1多一个
    　　　　　T0 ... Tj-1 Tj　...  Ti-j-1 ... Ti-2 Ti-1 即【T0 ... Tj】 = 【Ti-j-1 ... Ti-1】
```
　
    ```C
